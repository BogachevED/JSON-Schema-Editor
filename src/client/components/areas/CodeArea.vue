        ...
        <tbody>
          <tr>
            <td width="25%">
              <v-Button
                id="ButtonSave"
                label="Сохранить изменения в файле"
                @click="SaveNewJSON"
                icon="pi pi-save"
                class="p-mr-2"
              />
            ...
            <td width="25%" style="display: none">
              <a id="downloadlink" download="file.json">Download</a>
            </td>
          </tr>
        </tbody>
      </table>
            ...
            <table id="CoreTable" width="100%" cellpadding="2">
              <tbody>
                <tr v-for="(property, name) in File.content" :key="property">
                  <td v-if="name != 'properties'" width="20%">
                    <v-InputText
                      Id="InputKey"
                      align="center"
                      type="text"
                  ...
                  <td v-if="name != 'properties'" width="75%">
                    <v-InputText
                      Id="InputValue"
                      type="text"
                  ...
                  <td v-if="name != 'properties'" width="5%">
                    <v-Button
                      id="ButtonDelField"
...
export default {
    ...
    SaveNewJSON() {
      ...
      if (DivEx.children[0]) {
        ...
        this.$toast.add({
          severity: 'warn',
          summary: 'Оповещение!',
          detail: 'Необходимо сперва выбрать файл',
          life: 5000
        })
      }
    },
  ...
  data() {
    return {
      ...
      ArrayOfStrProperties: ['$schema', '$id', 'title', 'pattern', 'description', 'default'],
